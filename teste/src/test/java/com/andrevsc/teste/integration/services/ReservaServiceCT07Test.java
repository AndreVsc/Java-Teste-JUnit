...
@DisplayName("CT07 – parcelamento acima do limite lança IllegalArgumentException")
class ReservaServiceCT07Test extends ReservaServiceCTBase {
    ...
    void CT07_parcelasAcimaDoLimite_deveLancarIllegalArgumentException() {
        ...
        request.getPagamento().setNumeroParcelas(6);
